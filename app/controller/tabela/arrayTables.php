...
return [
    "agendamentos" => [
        ...
        "especifico" => ["agendar_sala.id", "usuario.nome as usuario", "turmas.nome as turma", "sala.nome as sala", "sala.bloco", "agendar_sala.dia", "agendar_sala.periodo"]
    ],
    "usuarios" => [
        "tabela" => "usuario",
        "owner_column" => "id",
    ...
    "salas" => [
        ...
        "especifico" => ["id", "nome", "bloco", "descricao"]
    ],
    "menssagem" => [
        "tabela" => 'revindicados',
        'owner_relation' => [
