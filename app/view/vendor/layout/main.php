...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="/app/view/vendor/creditos/css/creditos.css">
        <link rel="stylesheet" href="/app\view\vendor\tabelas\menuPainel\css\filtrotabela.css">
    ...
    require_once __DIR__ . '/../../../../app/view/vendor/layout/' . (($_SESSION['privilegio'] === 'admin') ? 'Top_admin' : 'Top_professor') . '.php';
} ?>
    <main class="content">
        <?php
