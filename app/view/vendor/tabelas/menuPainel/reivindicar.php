...
$dadosDono = BuscaInfoUser::buscaDonoAgendamento($id);
$eDonoDoAgendamento = ($dadosDono && (int)$dadosDono['id_usuario'] === (int)$userAtivo["id"])
?>
<div class="painel-wrapper">
    <form action="/reivindicado" method="post" class="Painel" onsubmit="bloqueiarevindicar(event)">
        ...
        <div class="editar-dados">
            <?= $engine->render() ?>
            <?php if ($eDonoDoAgendamento) { ?>
                <div class="alert-info">
                    <p>Este agendamento é seu. Você não pode reivindicá-lo.</p>
                </div>
            <?php } elseif ($engine->canSubmit()) { ?>
        ...
        <div class="buttons-cal-conf">
            <?php if ($eDonoDoAgendamento || !$engine->canSubmit()) echo "<p></p>"; ?>
